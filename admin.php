    ...
    <div class="col-sm-8 text-left"> 
      <div class="rowforW ">
          <div class="dive col-99" style="align-items: center; text-align: center;">    
            <img src="./images/avatar6.png" style="width: 200px; border-radius: 100%; padding-top: 20px; " alt="">
            <p style="font-size: 20px; text-align: center;">ADMIN - 001</p>
          </div> 
      </div> <!--//row end -->
      <div class="rowforW ">
      <?php
                    ...
                    ?>
          <dive class="form2" action="#">
            <div class="user-details"  style="padding: 5px; margin-left: 100px; font-size: 20px;">
