<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $invoice = $_FILES['uploadfilename']['tmp_name'];
      foreach($listOfItems as $item) {
         ...
         //var_dump($id);
         $sql = "INSERT INTO invoice_slip (`Invoice_No`, `Product_Name`, `Product_Code`, `Quantity`, `Total_Amount`, `Customer_Name`, `Customer_Address`, `Customer_ContactNo`, `Order_No`, `Bank_Slip`) VALUES(0,'$tempName','$tempCode','$tempQuantity','$tempPrice','$name','$address','$contact','$id','$invoice')";
         $result = mysqli_query($conn,$sql);
       }
      ...
      if($id > 0){
          // success
          echo '<script type="text/javascript">alert("' . 'Orderd  Successfully!' . '"); window.location.href="index.html";</script>';
    ...
    <div class="container">
        <div class="navbar" id="navbar">
            ...
            <ul id="MenuItems">
                ...
                <li><a class="active2" href="./BankDeposite.php">Payment</a></li>
            </ul>
            </nav>
     ...
     <div class="container">
         <div class="row">
             <img src="./images/bank-deposit.png" style="width: 10%;">
         </div>
         ...
         <div class="row">
             ...
             <div class="col-75">
                 ...
                 <form action="" method="post">
                     ...
                     <div class="col-50">
                         <h3>Payment</h3>
                         <label for="fname">Accepted Bank Deposite</label><hr>
                         <p>Bank : Bank Of Ceylon <br>Branch : Union Place<br>AccNo : 0123456789 <hr> Please Deposite this Account for your total-price<hr><br></p>
                         <div class="icon-containerPay">
                            <img src="./images/boc.png" style="width: 50%;" alt="">
                         </div>
                         <label for="bno">Bank Slip No(ref no)</label>
                         <input type="text" id="bno" name="bankslipno" placeholder="Ref No" required>
                         <label for="date">Deposite Date</label>
                         <input type="date" id="date" name="ddate" placeholder="" required>

                         <label for="upload"><i class="fa fa-upload"></i>&nbsp Upload Bank Slip</label>
                         <input type="file" method="post" enctype="multipart/form-data" id="upload" name="uploadfilename" required>
