  ...
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      ...
      <li > <a href="./DashboardAdmin.php"><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
        ...
        <li class="active2"> <a href="./customerList.php"><i class="fa fa-child"></i>&nbsp; Customer Details</a></li>
      ...
      <div class="w3-container">
        ...
        <?php
          ...
          <li class="w3-padding-16">
            ...
            <span class="w3-xlarge"><?php echo $row ['Customer_NIC']; ?> <br> <?php echo $row ['Customer_Name']; ?> <br> <?php echo $row ['Customer_Email']; ?> <br> <?php echo $row ['Customer_Address']; ?> <br>   <?php echo $row ['Customer_ContactNo']; ?></span><br>
          </li>
          <?php
        }
        ?>
