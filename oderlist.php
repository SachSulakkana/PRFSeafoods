  ...
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      ...
      <li > <a href="./DashboardAdmin.php"><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
        ...
        <li class="active2"> <a href="./orderlist.php"><i class="fa fa-shopping-bag"></i>&nbsp;Order List</a></li>
    ...
    <div class="col-sm-8 text-left">    
      ...
      <div class="w3-container">
        ...
        <?php
                    ...
                    $sql = "SELECT * FROM invoice_slip ORDER BY Buy_Date DESC" ;                        
          ...
          <li class="w3-padding-16">
            ...
            <img src="./images/avatar2.png" class="w3-left w3-circle w3-margin-right" style="width:45px;" ><br>
            <span class="w3-xlarge" ><?php echo $row ['Buy_Date']; ?> <br> <?php echo $row ['Customer_Name']; ?> <br> <?php echo $row ['Product_Code']; ?> - <?php echo $row ['Quantity']; ?> Bulks <br> RS.<?php echo $row ['Total_Amount']; ?></span><br>
          </li>
          <?php
        }
        ?>
