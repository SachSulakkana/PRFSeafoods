...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header" style="height: 80px;">
      ...
      <a class="navbar-brand" href="./Profile.html"><img src="./images/avatar2.png" style="width: 50px; border-radius: 50%;" alt=""><p style="font-size: 13px; text-align: center;"> <?php echo $user_check; ?></p></a>
    </div>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      ...
      <ul>
        <li class="active2"> <a href="./DashboardUser.php"><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
    ...
    <div class="rowforW ">
      ...
      <h1 style="font-size:52px;">Welcome !</h1>
      <p style="font-size:20px;">
        Our warmest congratulations to you on being a proud customer of our P.R.F Seafoods.plt (Ltd). We have been doing business continuously for almost two decades since 2013 because of the trust you have placed in us. We are still working to make our service more optimal for you. Our goal is to provide you with uninterrupted, friendly service 24 hours a day. It's important that you stay in touch with us. We hope you will continue to stay with us.</p>
      <hr>
