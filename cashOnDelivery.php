<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($id > 0){
          // success
          echo '<script type="text/javascript">alert("' . 'Ordered Successfully!' . '"); window.location.href="index.html";</script>';
...
<body>
    ...
    <div class="container">
        <div class="navbar" id="navbar">
            ...
            <ul id="MenuItems">
                ...
                <li><a class="active2" href="./CashOnDelivery.php">Payment</a></li>
            </ul>
            </nav>
    ...
    <div class="container">
        <div class="row">
            <img src="./images/COD2.png" style="width: 25%;">
        </div>
        ...
        <form action="" method="post">
            ...
            <div class="col-75">
             ...
             <!--   <form action="" method="post"> -->
                    ...
                    <div class="col-50">
                        ...
                        <input type="text" id="contact" name="contact" placeholder="07X XXX XXXX">
                        ...
                        <input type="text" id="country" name="country" placeholder="Sri Lanka">
                        ...
                        <label for="date"><i class="fa fa-calendar-check-o"></i> When you want Delivery</label>
                         <input type="datetime-local" id="date" name="ddate" placeholder="">
                    </div>

                    <div class="col-50">
                        <h3>Payment</h3>
                        <label for="fname">Accepted Cash on Delivery</label><hr>
                        <p>Thank you for dealing with us. We will make arrangements to receive your order within 2 weeks. We request you to prepare and keep the required funds for payments within this period. We are grateful for the trust you have placed in us.</p>
                        <div class="icon-containerPay">
                            <img src="./images/cod.png" style="width: 25%;" alt="">
                         </div>
                        <hr><br></p>
            ...
            <!-- </form> -->
                    ...
                    <label >
                    <input type="checkbox" checked="checked" name="sameadr">&nbsp Shipping address same as billing</input>
                    </label>
                    <input type="submit" value="Continue to checkout" class="btnPay" > <!-- id="myBtn2"  --> 
              </form>                     
                    <!-- The Modal -->
