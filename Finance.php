  ...
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      ...
      <li> <a href="./DashboardAdmin.php"><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
        ...
        <li class="active2"> <a href="./Finance.php"><i class=" fa fa-comments-o"></i>&nbsp; Comments</a></li>
      ...
      <div class="w3-container">
        ...
        <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
          ...
          <?php
                    ...
                    ?>
            <tr>
            <td>&emsp;<?php echo $row ['FirstName']; ?> <?php echo $row ['LastName']; ?></td>
            <td>&emsp;<?php echo $row ['Email']; ?></td>
            <td>&emsp;<?php echo $row ['Message']; ?></td>
          </tr>
          <?php
        }
        ?>
