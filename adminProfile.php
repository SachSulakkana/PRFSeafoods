<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($pwd1 == $pwd2){
      // administrator table update
      $sql = "UPDATE administrator SET  `AD_Name` = '$name', `AD_Address` = '$address', `AD_ContactNo` = '$contact', `AD_Email` = '$email', `UserName` = '$user', `Password` = '$pwd1' WHERE `AD_NIC` = '$nic'";
  ...
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      ...
      <li > <a href="./DashboardAdmin.php"><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
        <li class="active2"> <a href="./admin.php"><i class="fa fa-user-circle-o"></i>&nbsp; Profile</a></li>
    ...
    <div class="content">
        ...
        <?php
                    ...
                    $sql = "SELECT * FROM administrator where UserName = '$user_check'";                        
                        $result = mysqli_query($conn,$sql);
      ...
      <form action = "" method = "post">
        <div class="user-details">
             <div class="input-box">
            <span class="details">Administrator Name</span>
            <input type="text" value="<?php echo $row ['AD_Name']; ?>" name="name" placeholder="Enter your name" required>
          </div>
          
          <div class="input-box">
            <span class="details">NIC Number</span>
            <input type="text" value="<?php echo $row ['AD_NIC']; ?>" name="nic" placeholder="Enter your NIC" required readonly>
          </div>
         
          <div class="input-box">
            <span class="details">Address</span>
            <input type="text" value="<?php echo $row ['AD_Address']; ?>" name="address" placeholder="Enter your Address" required>
          </div>
          <div class="input-box">
            <span class="details">Contact Num</span>
            <input type="num" value="<?php echo $row ['AD_ContactNo']; ?>" name="contact" placeholder="Enter your Contact number" required>
          </div>
          <div class="input-box">
            <span class="details">E-mail</span>
            <input type="E-mail" value="<?php echo $row ['AD_Email']; ?>" name="email" placeholder="Enter your E-mail" required>
          </div>
          <div class="input-box">
            <span class="details">Usre Name</span>
            <input type="text" value="<?php echo $row ['UserName']; ?>" name="user" placeholder="Enter Your User Name" required readonly>
          </div>
          <div class="input-box">
